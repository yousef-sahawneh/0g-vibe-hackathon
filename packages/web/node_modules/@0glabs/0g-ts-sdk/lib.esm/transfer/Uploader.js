...
export class Uploader {
    ...
    async submitTransaction(submission, opts, retryOpts) {
        ...
        var [txReceipt, txErr] = await txWithGasAdjustment(this.flow, this.provider, 'submit', [{ data: submission, submitter: await this.flow.runner.getAddress() }], txOpts, retryOpts);
